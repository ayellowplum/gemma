...
export type GlobalConfig = {
  ...
  // Sonnet-1M configs
  hasShownS1MWelcomeV2?: Record<string, boolean> // Whether the Sonnet-1M premium welcome message has been shown per org
  ...
  firstStartTime?: string // ISO timestamp when Gemma was first started on this machine
  ...
  // Gemma usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Gemma OAuth token
  ...
  // Gemma hint protocol state (<claude-code-hint /> compatibility tags from CLIs/SDKs).
