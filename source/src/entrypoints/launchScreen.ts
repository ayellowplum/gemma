/**
 * Flashy animated launch screen for Gemma CLI.
...
// Gemma brand palette
const AMBER: Color = [230, 195, 120];
const WARM: Color = [140, 200, 245];
const CREAM: Color = [248, 230, 190];
const FIRE: Color = [82, 149, 220];
const DEEP: Color = [52, 92, 150];
const BLACK: Color = [0, 0, 0];

// Dense terminal-safe Gemma mark
const LOGO = [
  '                          █████████',
  '                         ███████████',
  '                         ██   ◉   ██',
...
const SUBTITLE = '  T  E  R  M  I  N  A  L    C  O  D  I  N  G';
