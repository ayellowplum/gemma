...
// Conditionally require()'d in GemmaBrandShell.tsx behind feature('KAIROS') ||
...
export function ChannelsNotice() {
  ...
  if (noAuth) {
    ...
    if ($[9] === Symbol.for("react.memo_cache_sentinel")) {
      t2 = <Text dimColor={true}>Channels require claude.ai authentication · run /login, then restart Gemma</Text>;
      $[9] = t2;
    } else {
      t2 = $[9];
    }
  ...
  let t2;
  if ($[24] !== flag) {
    t2 = <Text dimColor={true}>Experimental · inbound messages will be pushed into this session, this carries prompt injection risks. Restart Gemma without {flag} to disable.</Text>;
    $[24] = flag;
    $[25] = t2;
  } else {
    t2 = $[25];
