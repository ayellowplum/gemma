...
import { GemmaBrandShell } from './GemmaBrand/GemmaBrandShell.js';
...
// Memoed brand header: this box is the FIRST sibling before all MessageRows
...
// doesn't invalidate the brand subtree. GemmaBrand/StatusNotices internally
