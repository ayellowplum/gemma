...
export function GemmaMdExternalIncludesDialog(t0) {
  const $ = _c(18);
  const {
    onDone,
    isStandaloneDialog,
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t8 = <Text dimColor={true}>Important: Only use Gemma with files you trust. Accessing untrusted files may pose security risks{" "}<Link url="https://github.com/gemma-code/gemma" />{" "}</Text>;
    $[8] = t8;
  } else {
    t8 = $[8];
  }
