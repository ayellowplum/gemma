...
export function GemmaHelpGeneral() {
  const $ = _c(2);
  let t0;
  if ($[0] === Symbol.for("react.memo_cache_sentinel")) {
    t0 = <Box><Text>Gemma understands your codebase, makes edits with your permission, and executes commands right from your terminal.</Text></Box>;
    $[0] = t0;
  } else {
    t0 = $[0];
  }
