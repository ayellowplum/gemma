...
import { GemmaHelpCommands } from './GemmaHelpCommands.js';
import { GemmaHelpGeneral } from './GemmaHelpGeneral.js';
type Props = {
...
export function GemmaHelp(t0) {
  ...
  if ($[8] === Symbol.for("react.memo_cache_sentinel")) {
    t4 = <Tab key="general" title="general"><GemmaHelpGeneral /></Tab>;
    $[8] = t4;
  } else {
    t4 = $[8];
  }
  ...
  if ($[9] !== antOnlyCommands || $[10] !== builtinCommands || $[11] !== close || $[12] !== columns || $[13] !== customCommands || $[14] !== maxHeight) {
    ...
    if ($[16] !== builtinCommands || $[17] !== close || $[18] !== columns || $[19] !== maxHeight) {
      t5 = <Tab key="commands" title="commands"><GemmaHelpCommands commands={builtinCommands} maxHeight={maxHeight} columns={columns} title="Browse default commands:" onCancel={close} /></Tab>;
      $[16] = builtinCommands;
      $[17] = close;
      $[18] = columns;
      $[19] = maxHeight;
    ...
    if ($[21] !== close || $[22] !== columns || $[23] !== customCommands || $[24] !== maxHeight) {
      t6 = <Tab key="custom" title="custom-commands"><GemmaHelpCommands commands={customCommands} maxHeight={maxHeight} columns={columns} title="Browse custom commands:" emptyMessage="No custom commands found" onCancel={close} /></Tab>;
      $[21] = close;
      $[22] = columns;
      $[23] = customCommands;
      $[24] = maxHeight;
    ...
    if (false && antOnlyCommands.length > 0) {
      ...
      if ($[26] !== antOnlyCommands || $[27] !== close || $[28] !== columns || $[29] !== maxHeight) {
        t7 = <Tab key="ant-only" title="[ant-only]"><GemmaHelpCommands commands={antOnlyCommands} maxHeight={maxHeight} columns={columns} title="Browse ant-only commands:" onCancel={close} /></Tab>;
        $[26] = antOnlyCommands;
        $[27] = close;
        $[28] = columns;
        $[29] = maxHeight;
  ...
  let t6;
  if ($[31] !== tabs) {
    t6 = <Tabs title={false ? "/help" : `Gemma v${MACRO.VERSION}`} color="claude" defaultTab="general">{tabs}</Tabs>;
    $[31] = tabs;
    $[32] = t6;
  } else {
    t6 = $[32];
  ...
  if ($[33] === Symbol.for("react.memo_cache_sentinel")) {
    t7 = <Box marginTop={1}><Text>For more help:{" "}<Link url="https://github.com/gemma-code/gemma" /></Text></Box>;
    $[33] = t7;
  } else {
    t7 = $[33];
  }
  ...
  let t9;
  if ($[38] !== t6 || $[39] !== t8) {
    t9 = <Pane color="claude">{t6}{t7}{t8}</Pane>;
    $[38] = t6;
    $[39] = t8;
    $[40] = t9;
  } else {
