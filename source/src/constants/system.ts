...
const DEFAULT_PREFIX = `You are Gemma, a terminal coding assistant.`
const AGENT_SDK_CLAUDE_CODE_PRESET_PREFIX = `You are Gemma, a terminal coding assistant running within the Claude Agent SDK.`
